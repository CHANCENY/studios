...
<head>
    ...
    <!-- Favicons -->
    <link rel="icon" type="assets/main/image/png" href="assets/main/icon/favicon-32x32.png" sizes="32x32">
...
<!-- page 404 -->
<div class="page-404 section--bg" data-bg="assets/main/img/section/section.jpg">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="page-404__wrap">
                    <div class="page-404__content">
                        ...
                        <p class="page-404__text">The server error encountered</p>
