    ...
    <div class="row">
        ...
        <div class="col-8 border-4">
            ...
            <div class="mt-lg-4">
                ...
                <div class="progress" role="progressbar" aria-label="Basic example" aria-valuenow="<?php echo intval($percent) - count($showSubs); ?>" aria-valuemin="0" aria-valuemax="<?php echo $percent; ?>">
                    <div class="progress-bar" style="width: <?php echo intval($percent) - count($showSubs); ?>%"></div>
                    <span><?php echo intval($percent) - count($showSubs).'%'; ?></span>
                </div>
            </div>

            <div class="mt-lg-4">
                <h4 class="text-white-50 ms-0">Movies statistics</h4>
                <div class="progress" role="progressbar" aria-label="Basic example" aria-valuenow="<?php echo intval($percent) - count($moviesSubs) ?? 0; ?>" aria-valuemin="0" aria-valuemax="<?php echo $percent; ?>">
                    <div class="progress-bar text-center" style="width: <?php echo count($moviesSubs) ?? 0; ?>%"></div>
                    <span><?php echo intval($percent) - count($moviesSubs).'%'; ?></span>
                </div>
            </div>

            <div class="mt-lg-4">
                <h4 class="text-white-50 ms-0">Episodes statistics</h4>
                <div class="progress" role="progressbar" aria-label="Basic example" aria-valuenow="<?php echo intval($percent) - count($episodeSubs); ?>" aria-valuemin="0" aria-valuemax="<?php echo $percent; ?>">
                    <div class="progress-bar" style="width: <?php echo count($episodeSubs); ?>%"></div>
                    <span><?php echo intval($percent) - count($episodeSubs).'%'; ?></span>
                </div>
            </div>
